...
function loadLevel(whichLevel) {
    ...
    blueCar.reset("Blue Storm");
    greenCar.reset("Green Machine");
}
...
function drawAll() {
    clearScreen();
    // You don't need to wipe the screen if something is drawn on or over the pixels where the trace car images are drawn 
    drawTracks();
    blueCar.draw(carPic);
    greenCar.draw(car2Pic);
